...
export class AutonomousTreasury {
  ...
  private _initializeDefaultPortfolio(): void {
    const portfolio: TreasuryAsset[] = [
      { assetId: 'pnx', symbol: 'PNX', chainId: 4669201, balance: BigInt(10e9) * BigInt(1e18), valueUsd: 50_000_000, assetClass: 'native_token', yieldApy: 0, riskScore: 0.5, liquidityHorizon: 0, allocation: 30 },
      ...
      { assetId: 'pnx_lp', symbol: 'PNX-USDC-LP', chainId: 4669201, balance: BigInt(1e12), valueUsd: 10_000_000, assetClass: 'lp_token', yieldApy: 25, riskScore: 0.6, liquidityHorizon: 1, allocation: 15 },
      { assetId: 'rwa_bonds', symbol: 'US-T-BOND-RWA', chainId: 4669201, balance: BigInt(1e12), valueUsd: 5_000_000, assetClass: 'rwa', yieldApy: 5.2, riskScore: 0.1, liquidityHorizon: 7, allocation: 10 },
    ];
